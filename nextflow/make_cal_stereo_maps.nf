...
process find_pairs {
    ...
    script:
    """
    collect_stereo_pairs.py -v1 $baseDir/${params.VIDEO_DIR}/clips/cfr_${name}${VL}_cl_${start}_${end}.mkv -v2 $baseDir/${params.VIDEO_DIR}/clips/cfr_${name}${VR}_cl_${start}_${end}.mkv -m ${movement} -c ${checksize} -p $name -l 0 -e $distance
    """
}
